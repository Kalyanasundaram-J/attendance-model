                    ...
                    <?php
                        ...
                        if ($attendanceList AND $attendanceList->num_rows > 0) {
                            ...
                            while ($row = $attendanceList->fetch_assoc()) {
                                ...
                                echo "<td class='p-3 ".(($row["monday_status"]=='1')?'text-bg-success':(($row["monday_status"]=='Late')?'bg-success-subtle text-secondary':'bg-danger-subtle text-secondary'))."'>" . $row["monday_status"] . "</td>";
                                echo "<td class='p-3 ".(($row["tuesday_status"]=='1')?'text-bg-success':(($row["tuesday_status"]=='Late')?'bg-success-subtle text-secondary':'bg-danger-subtle text-secondary'))."'>" . $row["tuesday_status"] . "</td>";
                                echo "<td class='p-3 ".(($row["wednesday_status"]=='1')?'text-bg-success':(($row["wednesday_status"]=='Late')?'bg-success-subtle text-secondary':'bg-danger-subtle text-secondary'))."'>" . $row["wednesday_status"] . "</td>";
                                echo "<td class='p-3 ".(($row["thursday_status"]=='1')?'text-bg-success':(($row["thursday_status"]=='Late')?'bg-success-subtle text-secondary':'bg-danger-subtle text-secondary'))."'>" . $row["thursday_status"] . "</td>";
                                echo "<td class='p-3 ".(($row["friday_status"]=='1')?'text-bg-success':(($row["friday_status"]=='Late')?'bg-success-subtle text-secondary':'bg-danger-subtle text-secondary'))."'>" . $row["friday_status"] . "</td>";
